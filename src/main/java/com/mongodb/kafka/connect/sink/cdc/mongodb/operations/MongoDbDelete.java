...
public class MongoDbDelete implements CdcOperation {
    ...
    public WriteModel<BsonDocument> perform(final SinkDocument doc) {
        ...
        try {
	        	LOGGER.info("DELTE OPERATION: SinkDocument - Key: " + doc.getKeyDoc().toString());
	        	LOGGER.info("DELTE OPERATION: SinkDocument - Value: " + doc.getValueDoc().toString());
	        	...
	        	LOGGER.info("DELTE OPERATION: Filter Document: " + BsonDocument.parse(valueDoc.getDocument(JSON_DOC_DOCUMENT_KEY_FIELD_PATH).toJson()));
	        	return new DeleteOneModel<BsonDocument>(BsonDocument.parse(valueDoc.getDocument(JSON_DOC_DOCUMENT_KEY_FIELD_PATH).toJson()));
        } catch (Exception exc) {
