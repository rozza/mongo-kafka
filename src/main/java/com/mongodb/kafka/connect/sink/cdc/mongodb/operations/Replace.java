...
public class Replace implements MongoCdcOperation {
    ...
    public Either<WriteModel<BsonDocument>, Consumer<MongoClient>> process(final SinkDocument doc) {
        ...
        return Either.left(new ReplaceOneModel<>(getDocumentKey(changeStreamDocument),
                getFullDocument(changeStreamDocument), new ReplaceOptions().upsert(true)));
    }
