...
public abstract class MongoDBCdcHandler extends CdcHandler {
    private static final String OPERATION_TYPE_FIELD_PATH = "operationType";

    private final Map<OperationType, CdcOperation> operations = new HashMap<>();

    public MongoDBCdcHandler(final MongoSinkTopicConfig config) {
        super(config);
    }
