...
class MongoDbHandlerTest {
    ...
    private static final MongoDbHandler HANDLER_DEFAULT_MAPPING = new MongoDbHandler();
    private static final MongoDbHandler HANDLER_EMPTY_MAPPING = new MongoDbHandler(emptyMap());
